            ...
            if periodo == "15 dias":
                ...
                try:
                    ...
                    with col_g1:
                        ...
                        if fig1: st.pyplot(fig1)
                        else: st.info("Sem dados para gráfico de desempenho.")
                    with col_g2:
